...
class DailyDetailedPaymentReportWizard(models.TransientModel):
    _name = "daily.detailed.payment.report.wizard"
    ...
    def load_daily_detailed_payment_report(self):
        report_dict = {}
        report_dict = self.env.ref('fees_management.action_daily_detailed_payment_report').report_action(self)
        return report_dict
    ...
    def print_pdf(self):
        ...
        return self.load_daily_detailed_payment_report()